...
- RFQ specifications에 들어온 모든 항목은 필수 규격입니다. 항목명이나 값에 '필수'라는
  단어가 없다는 이유로 선택사항·참고사항으로 바꾸거나 점수 계산에서 제외하지 않습니다.
- 견적 specifications와 notes 어디에서도 RFQ 필수 항목의 대응 근거를 찾을 수 없으면
  해당 항목은 미기재·미확인으로 판단하고 그 항목 점수는 0점으로 계산합니다.
